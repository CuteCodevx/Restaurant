...
<section class="w3-container w3-padding-64 w3-brown w3-grayscale-min w3-large">
    <div class="w3-content">
        <h3 class="w3-center w3-jumbo" style="margin-bottom:64px">MY COMMENTS</h3>
        ...
        <div class="w3-card-4 w3-margin w3-white">
            <div class="w3-container">
                <h3><b>DETAILS</b></h3>
                <p>Restaurant Name: <span class="w3-xlarge"><b><%=comment.get(i).getResName()%></b></span></p>
                <p><span class="w3-xlarge"><b><%=comment.get(i).getUsername()%></b></span></p>

            </div>
            <div class="w3-container">
                <p><span class="w3-xlarge w3-opacity"><b><%=comment.get(i).getDate()%></b></span></p>
                <p>The point I give is: <span class="w3-xlarge"><b><%=comment.get(i).getGivePoint()%></b></span></p>
                <p><span class="w3-xlarge w3-text-red"><b><%=comment.get(i).getContent()%></b></span></p>
            </div>
        </div>
        <%}}else{  for(int i=(num-1)*4;i<comment.size();i++){%>
        <div class="w3-card-4 w3-margin w3-white">
            <div class="w3-container">
                <h3><b>DETAILS</b></h3>
                <p>Restaurant Name: <span class="w3-xlarge"><b><%=comment.get(i).getResName()%></b></span></p>
                <p><span class="w3-xlarge"><b><%=comment.get(i).getUsername()%></b></span>
                    <span class="w3-large w3-right w3-opacity"><b><%=comment.get(i).getDate()%></b></span>
                </p>
            ...
            <div class="w3-bar">
                ...
                <%
                    ...
                    for(int pageNum = 1;pageNum<=totalNum;pageNum++){
                        ...
                        if (num == pageNum){%>
                <a href="comment?list=<%=pageNum%>" class="w3-bar-item w3-light-grey w3-button"><%=pageNum%></a>
                <%}else{%>
                <a href="comment?list=<%=pageNum%>" class="w3-bar-item w3-button"><%=pageNum%></a>
                <%}%>
                <%}%>
                <a href="#" class="w3-bar-item w3-button w3-hover-black">»</a>
            </div>
        ...
        <%}else{%>
        <h3 class="w3-center"><b>You haven't comment any restaurant,  <a href="hello">go to look !</a></b></h3>
        <%}%>
    </div>
    <!-- The Contact Section -->
